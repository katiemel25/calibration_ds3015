...
for x in range(0,19):
    os.system("sed 's:_xstart_:%d:g' <_template_residuals.C >first_tower_test_a.C" %(x*52))
    os.system("sed 's:_xend_:%d:g' <first_tower_test_a.C>first_tower_test_b.C" %((x+1)*52))
